...
import { initialState, transition, serializeSession, restoreSession } from '../src/adaptive/learning.js'
import { validateCurriculum, videoLinks } from '../src/adaptive/curriculum.js'

const data = JSON.parse(readFileSync(new URL('../copy/adaptive/bloom.json', import.meta.url)))
